package com.example.jsonparsep9;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void parsexml(View v) {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(this, "Error in reading XML FILE", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void parsejson(View V) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(this, "Error in reading JSON file", Toast.LENGTH_SHORT).show();
        }
    }
